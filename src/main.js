...
function setup()
{
	...
	rowInput.size(50,AUTO);
	rowInput.input(function(){rowSlider.value(rowInput.value())});
	...
	colInput.position(10+colSlider.width,10);
	colInput.size(50,AUTO);
	colInput.input(function(){colSlider.value(colInput.value())});
